<template>
	<div id="edit-employee">
		...
		<form @submit.prevent="updateEmployee" class="col s12">
			...
			<router-link v-bind:to="{name: 'ViewEmployee', params: {employee_id: this.employee_id}}" class="btn grey">Cancel</router-link>
		</form>
	</div>
</template>
			...
			updateEmployee () {
				...
				.then(querySnapshot => {
					querySnapshot.forEach(doc => {
						...
						.then(() => this.$router.push({name: 'ViewEmployee', params: {employee_id: this.employee_id}}))
					})
				})
			}
		}
